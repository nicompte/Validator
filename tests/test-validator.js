...
describe('Rules', function() {
	describe('required', function() {
		...
		it('should succeed when 0', function() {
			Validator.rules.required(0).should.be.true;
		});
		it('should succeed when "a"', function() {
			Validator.rules.required("a").should.be.true;
		});
		it('should succeed when {}', function() {
	...
	describe('minLength', function() {
		it('should fail when "12"', function() {
	...
	describe('in', function() {
		it('["A"] should fail when "a"', function() {
			Validator.rules["in"]("a", ["A"]).should.be.false;
		});
		it('[] should fail when "a"', function() {
			Validator.rules["in"]("a", []).should.be.false;
		});
		it('[1, "b"] should fail when "1"', function() {
			Validator.rules["in"]("1", [1, "b"]).should.be.false;
		});
		it('["a", "b"] should succeed when "a"', function() {
			Validator.rules["in"]("a", ["a", "b"]).should.be.true;
		});
		it('[1 : "b"] should succeed when 1', function() {
	...
	describe('notIn', function() {
		it('["A"] should succeed when "a"', function() {
		...
		it('["a", "b"] should fail when "a"', function() {
	...
	describe('number', function() {
		...
		it('should fail when "1"', function() {
			Validator.rules.number("1").should.be.false;
		});
		it('should succeed when 1', function() {
	...
	describe('min', function() {
		it('1 should fail when "a"', function() {
			Validator.rules.min("a", 1).should.be.false;
		});
		it('1 should fail when 0', function() {
			Validator.rules.min(0, 1).should.be.false;
		});
		it('1 should succeed when 1', function() {
			Validator.rules.min(1, 1).should.be.true;
		});
		it('1 should succeed when 2', function() {
			Validator.rules.min(2, 1).should.be.true;
		});
		it('1should fail when null', function() {
	...
	describe('smallerThan', function() {
		...
		it('1 should fail when 1', function() {
	...
	describe('range', function() {
		it('[3, 5] should fail when "a"', function() {
			Validator.rules.range("a", [3, 5]).should.be.false;
		});
		it('[3, 5] should fail when 0', function() {
			Validator.rules.range(0, [3, 5]).should.be.false;
		});
		it('[3, 5] should succeed when 3', function() {
			Validator.rules.range(3, [3, 5]).should.be.true;
		});
		it('[3, 5] should succeed when 5', function() {
			Validator.rules.range(5, [3, 5]).should.be.true;
		});
		it('[3, 5] should fail when null', function() {
	...
	describe('isnt', function() {
		it('1 should succeed when "a"', function() {
